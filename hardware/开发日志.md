...
python hardware/tools/read_feetech7.py \
  ...
  --samples 20 \
  --period 0.5 \
  --log logs/hardware/feetech7_first_read.jsonl
```
...
```text
logs/hardware/feetech7_first_read.jsonl
```
...
```text
logs/hardware/map_wrist_yaw.jsonl
logs/hardware/map_wrist_roll.jsonl
logs/hardware/map_gripper.jsonl
logs/hardware/map_wrist_flex.jsonl
logs/hardware/map_shoulder_lift.jsonl
logs/hardware/map_shoulder_pan.jsonl
```
...
logs/hardware/wrist_handeye/<timestamp>/
```
