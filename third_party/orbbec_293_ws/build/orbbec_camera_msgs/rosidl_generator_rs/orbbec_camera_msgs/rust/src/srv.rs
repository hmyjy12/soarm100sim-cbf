...
impl Default for GetDeviceConfig_Request {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(super::srv::rmw::GetDeviceConfig_Request::default())
  }
}

impl rosidl_runtime_rs::Message for GetDeviceConfig_Request {
  type RmwMsg = super::srv::rmw::GetDeviceConfig_Request;
...
pub struct GetDeviceConfig_Response {
    ...
    pub device_preset: std::string::String,


    // This member is not documented.
    #[allow(missing_docs)]
    pub preset_version: std::string::String,


    // This member is not documented.
    #[allow(missing_docs)]
    pub color_preset: std::string::String,


    // This member is not documented.
    #[allow(missing_docs)]
    pub depth_precision: std::string::String,


    // This member is not documented.
    #[allow(missing_docs)]
    pub disparity_to_depth_mode: std::string::String,


    // This member is not documented.
    #[allow(missing_docs)]
    pub exposure_range_mode: std::string::String,
    ...
    // This member is not documented.
    #[allow(missing_docs)]
    pub align_mode: std::string::String,


    // This member is not documented.
    #[allow(missing_docs)]
    pub align_target_stream: std::string::String,


    // This member is not documented.
    #[allow(missing_docs)]
    pub frame_aggregate_mode: std::string::String,
    ...
    // This member is not documented.
    #[allow(missing_docs)]
    pub time_domain: std::string::String,


    // This member is not documented.
    #[allow(missing_docs)]
    pub sync_mode: std::string::String,


    // This member is not documented.
    #[allow(missing_docs)]
    pub intra_camera_sync_reference: std::string::String,
...
impl Default for GetDeviceConfig_Response {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(super::srv::rmw::GetDeviceConfig_Response::default())
  }
}

impl rosidl_runtime_rs::Message for GetDeviceConfig_Response {
  type RmwMsg = super::srv::rmw::GetDeviceConfig_Response;

  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        schema_version: msg.schema_version.as_str().into(),
        device_preset: msg.device_preset.as_str().into(),
        preset_version: msg.preset_version.as_str().into(),
        color_preset: msg.color_preset.as_str().into(),
        depth_precision: msg.depth_precision.as_str().into(),
        disparity_to_depth_mode: msg.disparity_to_depth_mode.as_str().into(),
        exposure_range_mode: msg.exposure_range_mode.as_str().into(),
        depth_registration: msg.depth_registration,
        align_mode: msg.align_mode.as_str().into(),
        align_target_stream: msg.align_target_stream.as_str().into(),
        frame_aggregate_mode: msg.frame_aggregate_mode.as_str().into(),
        enable_frame_sync: msg.enable_frame_sync,
        time_domain: msg.time_domain.as_str().into(),
        sync_mode: msg.sync_mode.as_str().into(),
        intra_camera_sync_reference: msg.intra_camera_sync_reference.as_str().into(),
        data_json: msg.data_json.as_str().into(),
        success: msg.success,
        message: msg.message.as_str().into(),
      }),
      std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
  ...
  fn from_rmw_message(msg: Self::RmwMsg) -> Self {
    Self {
      ...
      device_preset: msg.device_preset.to_string(),
      preset_version: msg.preset_version.to_string(),
      color_preset: msg.color_preset.to_string(),
      depth_precision: msg.depth_precision.to_string(),
      disparity_to_depth_mode: msg.disparity_to_depth_mode.to_string(),
      exposure_range_mode: msg.exposure_range_mode.to_string(),
      depth_registration: msg.depth_registration,
      align_mode: msg.align_mode.to_string(),
      align_target_stream: msg.align_target_stream.to_string(),
      frame_aggregate_mode: msg.frame_aggregate_mode.to_string(),
      enable_frame_sync: msg.enable_frame_sync,
      time_domain: msg.time_domain.to_string(),
      sync_mode: msg.sync_mode.to_string(),
      intra_camera_sync_reference: msg.intra_camera_sync_reference.to_string(),
      data_json: msg.data_json.to_string(),
      success: msg.success,
      message: msg.message.to_string(),
    }
  }
...
pub struct SetFilter_Request {
    ...
    // This member is not documented.
    #[allow(missing_docs)]
    pub filter_config: Vec<super::msg::DepthFilterParam>,
  ...
  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        ...
        filter_config: msg.filter_config
          .into_iter()
...
impl Default for SetBagRecording_Request {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(super::srv::rmw::SetBagRecording_Request::default())
  }
}

impl rosidl_runtime_rs::Message for SetBagRecording_Request {
  type RmwMsg = super::srv::rmw::SetBagRecording_Request;
...
impl Default for SetBagRecording_Response {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(super::srv::rmw::SetBagRecording_Response::default())
  }
}

impl rosidl_runtime_rs::Message for SetBagRecording_Response {
  type RmwMsg = super::srv::rmw::SetBagRecording_Response;
