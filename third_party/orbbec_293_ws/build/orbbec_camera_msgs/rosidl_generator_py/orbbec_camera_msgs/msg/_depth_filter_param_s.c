...
bool orbbec_camera_msgs__msg__depth_filter_param__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("orbbec_camera_msgs.msg._depth_filter_param.DepthFilterParam", full_classname_dest, 59) == 0);
  }
  orbbec_camera_msgs__msg__DepthFilterParam * ros_message = _ros_message;
  {  // name
...
{
  /* NOTE(esteve): Call constructor of DepthFilterParam */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("orbbec_camera_msgs.msg._depth_filter_param");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DepthFilterParam");
