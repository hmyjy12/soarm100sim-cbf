...
class Init_SetFilter_Request_filter_config
{
public:
  explicit Init_SetFilter_Request_filter_config(::orbbec_camera_msgs::srv::SetFilter_Request & msg)
  : msg_(msg)
  {}
  ::orbbec_camera_msgs::srv::SetFilter_Request filter_config(::orbbec_camera_msgs::srv::SetFilter_Request::_filter_config_type arg)
  {
    msg_.filter_config = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_SetFilter_Request_filter_config filter_param(::orbbec_camera_msgs::srv::SetFilter_Request::_filter_param_type arg)
  {
    msg_.filter_param = std::move(arg);
    return Init_SetFilter_Request_filter_config(msg_);
  }
