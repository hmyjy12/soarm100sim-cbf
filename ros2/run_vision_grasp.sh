...
SHOW_WINDOW="false"
ENABLE_MUJOCO="false"
ENABLE_MUJOCO_BACKEND="true"
ENABLE_MUJOCO_CAMERA="true"
ENABLE_SDF_BACKEND="false"
ENABLE_ANYGRASP_PLANNER="true"
...
MUJOCO_OBSTACLE_MOTION_PERIOD="5.0"  #动态障碍物运动周期
MUJOCO_MJCF=""
...
AUTO_GOAL_DELAY="4.0" #启动后等待4秒再发送自动抓取目标
AUTO_EXECUTE_GRASP="true"
