...
#include "soarm100_interfaces/msg/detail/tracked_target2_d__rosidl_typesupport_fastrtps_c.h"
...
using _TrackedTarget2D__ros_msg_type = soarm100_interfaces__msg__TrackedTarget2D;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _TrackedTarget2D__ros_msg_type * ros_message = static_cast<const _TrackedTarget2D__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: reference_u
  {
    cdr << ros_message->reference_u;
  }

  // Field name: reference_v
  {
  ...
  // Field name: lost_frames
  {
    cdr << ros_message->lost_frames;
  }

  // Field name: replan_required
  {
  ...
  void * untyped_ros_message)
{
  ...
  _TrackedTarget2D__ros_msg_type * ros_message = static_cast<_TrackedTarget2D__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _TrackedTarget2D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_soarm100_interfaces__msg__TrackedTarget2D(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = soarm100_interfaces__msg__TrackedTarget2D;
    is_plain =
      (
...
static size_t _TrackedTarget2D__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_soarm100_interfaces__msg__TrackedTarget2D(
...
static message_type_support_callbacks_t __callbacks_TrackedTarget2D = {
...
static rosidl_message_type_support_t _TrackedTarget2D__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_TrackedTarget2D,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, soarm100_interfaces, msg, TrackedTarget2D)() {
  return &_TrackedTarget2D__type_support;
}
