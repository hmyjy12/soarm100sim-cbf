...
static const _TrackedTarget2D_type_support_symbol_names_t _TrackedTarget2D_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, soarm100_interfaces, msg, TrackedTarget2D)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, soarm100_interfaces, msg, TrackedTarget2D)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, soarm100_interfaces, msg, TrackedTarget2D)() {
  return &::soarm100_interfaces::msg::rosidl_typesupport_c::TrackedTarget2D_message_type_support_handle;
}
