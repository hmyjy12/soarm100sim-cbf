...
#ifndef SOARM100_INTERFACES__SRV__DETAIL__MOVE_NAMED_POSE__FUNCTIONS_H_
#define SOARM100_INTERFACES__SRV__DETAIL__MOVE_NAMED_POSE__FUNCTIONS_H_
...
/// Initialize srv/MoveNamedPose message.
/**
...
/// Finalize srv/MoveNamedPose message.
/**
...
/// Create srv/MoveNamedPose message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * soarm100_interfaces__srv__MoveNamedPose_Request__init().
...
/// Destroy srv/MoveNamedPose message.
/**
 * It calls
 * soarm100_interfaces__srv__MoveNamedPose_Request__fini()
...
/// Check for srv/MoveNamedPose message equality.
/**
...
/// Copy a srv/MoveNamedPose message.
/**
...
/// Initialize array of srv/MoveNamedPose messages.
/**
...
/// Finalize array of srv/MoveNamedPose messages.
/**
 * It calls
 * soarm100_interfaces__srv__MoveNamedPose_Request__fini()
...
/// Create array of srv/MoveNamedPose messages.
/**
 * It allocates the memory for the array and calls
 * soarm100_interfaces__srv__MoveNamedPose_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/MoveNamedPose messages.
/**
 * It calls
 * soarm100_interfaces__srv__MoveNamedPose_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/MoveNamedPose message array equality.
/**
...
/// Copy an array of srv/MoveNamedPose messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * soarm100_interfaces__srv__MoveNamedPose_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_soarm100_interfaces
...
/**
 * It calls
 * soarm100_interfaces__srv__MoveNamedPose_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_soarm100_interfaces
...
/**
 * It allocates the memory for the array and calls
 * soarm100_interfaces__srv__MoveNamedPose_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_soarm100_interfaces
...
/**
 * It calls
 * soarm100_interfaces__srv__MoveNamedPose_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SOARM100_INTERFACES__SRV__DETAIL__MOVE_NAMED_POSE__FUNCTIONS_H_
