...
SAFE_POSE_FILE="hardware/calibration/policy_ready_static_cbf.json"
...
while [[ $# -gt 0 ]]; do
  case "$1" in
    ...
    --safe-pose) SAFE_POSE_FILE="$2"; shift 2 ;;
...
echo "[hardware_controller] approved safe pose=$SAFE_POSE_FILE"
