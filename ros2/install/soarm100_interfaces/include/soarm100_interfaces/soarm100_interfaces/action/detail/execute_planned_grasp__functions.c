...
soarm100_interfaces__action__ExecutePlannedGrasp_Goal__init(soarm100_interfaces__action__ExecutePlannedGrasp_Goal * msg)
{
  ...
  // target_pos
  if (!rosidl_runtime_c__String__init(&msg->target_pos)) {
    soarm100_interfaces__action__ExecutePlannedGrasp_Goal__fini(msg);
    return false;
  }
  // traj_log
  if (!rosidl_runtime_c__String__init(&msg->traj_log)) {
    soarm100_interfaces__action__ExecutePlannedGrasp_Goal__fini(msg);
    return false;
  }
  return true;
...
soarm100_interfaces__action__ExecutePlannedGrasp_Goal__fini(soarm100_interfaces__action__ExecutePlannedGrasp_Goal * msg)
{
  ...
  // target_pos
  rosidl_runtime_c__String__fini(&msg->target_pos);
  // traj_log
  rosidl_runtime_c__String__fini(&msg->traj_log);
}
  ...
  soarm100_interfaces__action__ExecutePlannedGrasp_Goal * output)
{
  ...
  // traj_log
  if (!rosidl_runtime_c__String__copy(
      &(input->traj_log), &(output->traj_log)))
  {
    return false;
  }
  return true;
...
soarm100_interfaces__action__ExecutePlannedGrasp_Goal__create()
{
  ...
  soarm100_interfaces__action__ExecutePlannedGrasp_Goal * msg = (soarm100_interfaces__action__ExecutePlannedGrasp_Goal *)allocator.allocate(sizeof(soarm100_interfaces__action__ExecutePlannedGrasp_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(soarm100_interfaces__action__ExecutePlannedGrasp_Goal));
  bool success = soarm100_interfaces__action__ExecutePlannedGrasp_Goal__init(msg);
  if (!success) {
...
soarm100_interfaces__action__ExecutePlannedGrasp_Goal__Sequence__init(soarm100_interfaces__action__ExecutePlannedGrasp_Goal__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  soarm100_interfaces__action__ExecutePlannedGrasp_Goal * data = NULL;

  if (size) {
    data = (soarm100_interfaces__action__ExecutePlannedGrasp_Goal *)allocator.zero_allocate(size, sizeof(soarm100_interfaces__action__ExecutePlannedGrasp_Goal), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = soarm100_interfaces__action__ExecutePlannedGrasp_Goal__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        soarm100_interfaces__action__ExecutePlannedGrasp_Goal__fini(&data[i - 1]);
      }
...
soarm100_interfaces__action__ExecutePlannedGrasp_Goal__Sequence__fini(soarm100_interfaces__action__ExecutePlannedGrasp_Goal__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      soarm100_interfaces__action__ExecutePlannedGrasp_Goal__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  soarm100_interfaces__action__ExecutePlannedGrasp_Goal__Sequence * array = (soarm100_interfaces__action__ExecutePlannedGrasp_Goal__Sequence *)allocator.allocate(sizeof(soarm100_interfaces__action__ExecutePlannedGrasp_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = soarm100_interfaces__action__ExecutePlannedGrasp_Goal__Sequence__init(array, size);
  if (!success) {
...
soarm100_interfaces__action__ExecutePlannedGrasp_Goal__Sequence__destroy(soarm100_interfaces__action__ExecutePlannedGrasp_Goal__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    soarm100_interfaces__action__ExecutePlannedGrasp_Goal__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
soarm100_interfaces__action__ExecutePlannedGrasp_Goal__Sequence__are_equal(const soarm100_interfaces__action__ExecutePlannedGrasp_Goal__Sequence * lhs, const soarm100_interfaces__action__ExecutePlannedGrasp_Goal__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!soarm100_interfaces__action__ExecutePlannedGrasp_Goal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  soarm100_interfaces__action__ExecutePlannedGrasp_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(soarm100_interfaces__action__ExecutePlannedGrasp_Goal);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    soarm100_interfaces__action__ExecutePlannedGrasp_Goal * data =
      (soarm100_interfaces__action__ExecutePlannedGrasp_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!soarm100_interfaces__action__ExecutePlannedGrasp_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          soarm100_interfaces__action__ExecutePlannedGrasp_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!soarm100_interfaces__action__ExecutePlannedGrasp_Goal__copy(
...
soarm100_interfaces__action__ExecutePlannedGrasp_Result__init(soarm100_interfaces__action__ExecutePlannedGrasp_Result * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->reason)) {
    soarm100_interfaces__action__ExecutePlannedGrasp_Result__fini(msg);
    return false;
  }
  // lift_height
  // return_code
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  soarm100_interfaces__action__ExecutePlannedGrasp_Result * msg = (soarm100_interfaces__action__ExecutePlannedGrasp_Result *)allocator.allocate(sizeof(soarm100_interfaces__action__ExecutePlannedGrasp_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(soarm100_interfaces__action__ExecutePlannedGrasp_Result));
  bool success = soarm100_interfaces__action__ExecutePlannedGrasp_Result__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
soarm100_interfaces__action__ExecutePlannedGrasp_Result__Sequence__init(soarm100_interfaces__action__ExecutePlannedGrasp_Result__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  soarm100_interfaces__action__ExecutePlannedGrasp_Result * data = NULL;

  if (size) {
    data = (soarm100_interfaces__action__ExecutePlannedGrasp_Result *)allocator.zero_allocate(size, sizeof(soarm100_interfaces__action__ExecutePlannedGrasp_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = soarm100_interfaces__action__ExecutePlannedGrasp_Result__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        soarm100_interfaces__action__ExecutePlannedGrasp_Result__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
soarm100_interfaces__action__ExecutePlannedGrasp_Result__Sequence__fini(soarm100_interfaces__action__ExecutePlannedGrasp_Result__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      soarm100_interfaces__action__ExecutePlannedGrasp_Result__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  soarm100_interfaces__action__ExecutePlannedGrasp_Result__Sequence * array = (soarm100_interfaces__action__ExecutePlannedGrasp_Result__Sequence *)allocator.allocate(sizeof(soarm100_interfaces__action__ExecutePlannedGrasp_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = soarm100_interfaces__action__ExecutePlannedGrasp_Result__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
soarm100_interfaces__action__ExecutePlannedGrasp_Result__Sequence__destroy(soarm100_interfaces__action__ExecutePlannedGrasp_Result__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    soarm100_interfaces__action__ExecutePlannedGrasp_Result__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
soarm100_interfaces__action__ExecutePlannedGrasp_Result__Sequence__are_equal(const soarm100_interfaces__action__ExecutePlannedGrasp_Result__Sequence * lhs, const soarm100_interfaces__action__ExecutePlannedGrasp_Result__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!soarm100_interfaces__action__ExecutePlannedGrasp_Result__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  soarm100_interfaces__action__ExecutePlannedGrasp_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(soarm100_interfaces__action__ExecutePlannedGrasp_Result);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    soarm100_interfaces__action__ExecutePlannedGrasp_Result * data =
      (soarm100_interfaces__action__ExecutePlannedGrasp_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!soarm100_interfaces__action__ExecutePlannedGrasp_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          soarm100_interfaces__action__ExecutePlannedGrasp_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!soarm100_interfaces__action__ExecutePlannedGrasp_Result__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
soarm100_interfaces__action__ExecutePlannedGrasp_Feedback__init(soarm100_interfaces__action__ExecutePlannedGrasp_Feedback * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->stage)) {
    soarm100_interfaces__action__ExecutePlannedGrasp_Feedback__fini(msg);
    return false;
  }
  // reason
  if (!rosidl_runtime_c__String__init(&msg->reason)) {
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  soarm100_interfaces__action__ExecutePlannedGrasp_Feedback * msg = (soarm100_interfaces__action__ExecutePlannedGrasp_Feedback *)allocator.allocate(sizeof(soarm100_interfaces__action__ExecutePlannedGrasp_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(soarm100_interfaces__action__ExecutePlannedGrasp_Feedback));
  bool success = soarm100_interfaces__action__ExecutePlannedGrasp_Feedback__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
soarm100_interfaces__action__ExecutePlannedGrasp_Feedback__Sequence__init(soarm100_interfaces__action__ExecutePlannedGrasp_Feedback__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  soarm100_interfaces__action__ExecutePlannedGrasp_Feedback * data = NULL;

  if (size) {
    data = (soarm100_interfaces__action__ExecutePlannedGrasp_Feedback *)allocator.zero_allocate(size, sizeof(soarm100_interfaces__action__ExecutePlannedGrasp_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = soarm100_interfaces__action__ExecutePlannedGrasp_Feedback__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        soarm100_interfaces__action__ExecutePlannedGrasp_Feedback__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
soarm100_interfaces__action__ExecutePlannedGrasp_Feedback__Sequence__fini(soarm100_interfaces__action__ExecutePlannedGrasp_Feedback__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      soarm100_interfaces__action__ExecutePlannedGrasp_Feedback__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  soarm100_interfaces__action__ExecutePlannedGrasp_Feedback__Sequence * array = (soarm100_interfaces__action__ExecutePlannedGrasp_Feedback__Sequence *)allocator.allocate(sizeof(soarm100_interfaces__action__ExecutePlannedGrasp_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = soarm100_interfaces__action__ExecutePlannedGrasp_Feedback__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
soarm100_interfaces__action__ExecutePlannedGrasp_Feedback__Sequence__destroy(soarm100_interfaces__action__ExecutePlannedGrasp_Feedback__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    soarm100_interfaces__action__ExecutePlannedGrasp_Feedback__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
soarm100_interfaces__action__ExecutePlannedGrasp_Feedback__Sequence__are_equal(const soarm100_interfaces__action__ExecutePlannedGrasp_Feedback__Sequence * lhs, const soarm100_interfaces__action__ExecutePlannedGrasp_Feedback__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!soarm100_interfaces__action__ExecutePlannedGrasp_Feedback__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  soarm100_interfaces__action__ExecutePlannedGrasp_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(soarm100_interfaces__action__ExecutePlannedGrasp_Feedback);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    soarm100_interfaces__action__ExecutePlannedGrasp_Feedback * data =
      (soarm100_interfaces__action__ExecutePlannedGrasp_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!soarm100_interfaces__action__ExecutePlannedGrasp_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          soarm100_interfaces__action__ExecutePlannedGrasp_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!soarm100_interfaces__action__ExecutePlannedGrasp_Feedback__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Request__init(soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Request * msg)
{
  ...
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Request__fini(msg);
    return false;
  }
  // goal
  if (!soarm100_interfaces__action__ExecutePlannedGrasp_Goal__init(&msg->goal)) {
    soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Request__fini(msg);
    return false;
  }
  return true;
...
soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Request__fini(soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Request * msg)
{
  ...
  // goal
  soarm100_interfaces__action__ExecutePlannedGrasp_Goal__fini(&msg->goal);
}
...
soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Request__are_equal(const soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Request * lhs, const soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Request * rhs)
{
  ...
  // goal
  if (!soarm100_interfaces__action__ExecutePlannedGrasp_Goal__are_equal(
      &(lhs->goal), &(rhs->goal)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Request * msg = (soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Request *)allocator.allocate(sizeof(soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Request));
  bool success = soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Request__Sequence__init(soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Request * data = NULL;

  if (size) {
    data = (soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Request *)allocator.zero_allocate(size, sizeof(soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Request__Sequence__fini(soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Request__Sequence * array = (soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Request__Sequence *)allocator.allocate(sizeof(soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Request__Sequence__destroy(soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Request__Sequence__are_equal(const soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Request__Sequence * lhs, const soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Request * data =
      (soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Response__init(soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Response * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Response * msg = (soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Response *)allocator.allocate(sizeof(soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Response));
  bool success = soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Response__Sequence__init(soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Response * data = NULL;

  if (size) {
    data = (soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Response *)allocator.zero_allocate(size, sizeof(soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Response__Sequence__fini(soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Response__Sequence * array = (soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Response__Sequence *)allocator.allocate(sizeof(soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Response__Sequence__destroy(soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Response__Sequence__are_equal(const soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Response__Sequence * lhs, const soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Response * data =
      (soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!soarm100_interfaces__action__ExecutePlannedGrasp_SendGoal_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Request__init(soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Request * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Request__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Request * msg = (soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Request *)allocator.allocate(sizeof(soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Request));
  bool success = soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Request__Sequence__init(soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Request * data = NULL;

  if (size) {
    data = (soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Request *)allocator.zero_allocate(size, sizeof(soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Request__Sequence__fini(soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Request__Sequence * array = (soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Request__Sequence *)allocator.allocate(sizeof(soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Request__Sequence__destroy(soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Request__Sequence__are_equal(const soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Request__Sequence * lhs, const soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Request * data =
      (soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Response__init(soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Response * msg)
{
  ...
  // status
  // result
  if (!soarm100_interfaces__action__ExecutePlannedGrasp_Result__init(&msg->result)) {
    soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Response__fini(msg);
    return false;
  }
  return true;
}
...
soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Response__fini(soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Response * msg)
{
  ...
  // status
  // result
  soarm100_interfaces__action__ExecutePlannedGrasp_Result__fini(&msg->result);
}
...
soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Response__are_equal(const soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Response * lhs, const soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Response * rhs)
{
  ...
  // result
  if (!soarm100_interfaces__action__ExecutePlannedGrasp_Result__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Response * msg = (soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Response *)allocator.allocate(sizeof(soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Response));
  bool success = soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Response__Sequence__init(soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Response * data = NULL;

  if (size) {
    data = (soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Response *)allocator.zero_allocate(size, sizeof(soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Response__Sequence__fini(soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Response__Sequence * array = (soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Response__Sequence *)allocator.allocate(sizeof(soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Response__Sequence__destroy(soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Response__Sequence__are_equal(const soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Response__Sequence * lhs, const soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Response * data =
      (soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!soarm100_interfaces__action__ExecutePlannedGrasp_GetResult_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
soarm100_interfaces__action__ExecutePlannedGrasp_FeedbackMessage__init(soarm100_interfaces__action__ExecutePlannedGrasp_FeedbackMessage * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    soarm100_interfaces__action__ExecutePlannedGrasp_FeedbackMessage__fini(msg);
    return false;
  }
  // feedback
  if (!soarm100_interfaces__action__ExecutePlannedGrasp_Feedback__init(&msg->feedback)) {
    soarm100_interfaces__action__ExecutePlannedGrasp_FeedbackMessage__fini(msg);
    return false;
  }
  return true;
...
soarm100_interfaces__action__ExecutePlannedGrasp_FeedbackMessage__fini(soarm100_interfaces__action__ExecutePlannedGrasp_FeedbackMessage * msg)
{
  ...
  unique_identifier_msgs__msg__UUID__fini(&msg->goal_id);
  // feedback
  soarm100_interfaces__action__ExecutePlannedGrasp_Feedback__fini(&msg->feedback);
}
...
soarm100_interfaces__action__ExecutePlannedGrasp_FeedbackMessage__are_equal(const soarm100_interfaces__action__ExecutePlannedGrasp_FeedbackMessage * lhs, const soarm100_interfaces__action__ExecutePlannedGrasp_FeedbackMessage * rhs)
{
  ...
  // feedback
  if (!soarm100_interfaces__action__ExecutePlannedGrasp_Feedback__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  soarm100_interfaces__action__ExecutePlannedGrasp_FeedbackMessage * msg = (soarm100_interfaces__action__ExecutePlannedGrasp_FeedbackMessage *)allocator.allocate(sizeof(soarm100_interfaces__action__ExecutePlannedGrasp_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(soarm100_interfaces__action__ExecutePlannedGrasp_FeedbackMessage));
  bool success = soarm100_interfaces__action__ExecutePlannedGrasp_FeedbackMessage__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
soarm100_interfaces__action__ExecutePlannedGrasp_FeedbackMessage__Sequence__init(soarm100_interfaces__action__ExecutePlannedGrasp_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  soarm100_interfaces__action__ExecutePlannedGrasp_FeedbackMessage * data = NULL;

  if (size) {
    data = (soarm100_interfaces__action__ExecutePlannedGrasp_FeedbackMessage *)allocator.zero_allocate(size, sizeof(soarm100_interfaces__action__ExecutePlannedGrasp_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = soarm100_interfaces__action__ExecutePlannedGrasp_FeedbackMessage__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        soarm100_interfaces__action__ExecutePlannedGrasp_FeedbackMessage__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
soarm100_interfaces__action__ExecutePlannedGrasp_FeedbackMessage__Sequence__fini(soarm100_interfaces__action__ExecutePlannedGrasp_FeedbackMessage__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      soarm100_interfaces__action__ExecutePlannedGrasp_FeedbackMessage__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  soarm100_interfaces__action__ExecutePlannedGrasp_FeedbackMessage__Sequence * array = (soarm100_interfaces__action__ExecutePlannedGrasp_FeedbackMessage__Sequence *)allocator.allocate(sizeof(soarm100_interfaces__action__ExecutePlannedGrasp_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = soarm100_interfaces__action__ExecutePlannedGrasp_FeedbackMessage__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
soarm100_interfaces__action__ExecutePlannedGrasp_FeedbackMessage__Sequence__destroy(soarm100_interfaces__action__ExecutePlannedGrasp_FeedbackMessage__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    soarm100_interfaces__action__ExecutePlannedGrasp_FeedbackMessage__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
soarm100_interfaces__action__ExecutePlannedGrasp_FeedbackMessage__Sequence__are_equal(const soarm100_interfaces__action__ExecutePlannedGrasp_FeedbackMessage__Sequence * lhs, const soarm100_interfaces__action__ExecutePlannedGrasp_FeedbackMessage__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!soarm100_interfaces__action__ExecutePlannedGrasp_FeedbackMessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  soarm100_interfaces__action__ExecutePlannedGrasp_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(soarm100_interfaces__action__ExecutePlannedGrasp_FeedbackMessage);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    soarm100_interfaces__action__ExecutePlannedGrasp_FeedbackMessage * data =
      (soarm100_interfaces__action__ExecutePlannedGrasp_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!soarm100_interfaces__action__ExecutePlannedGrasp_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          soarm100_interfaces__action__ExecutePlannedGrasp_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!soarm100_interfaces__action__ExecutePlannedGrasp_FeedbackMessage__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
